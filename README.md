...
The management team at Sullivan’s Grocery began noticing a pattern: overstocked shelves for some items, while others ran out too quickly. High turnover products were not always the highest revenue drivers. Worse still, a growing number of products were nearing their expiration dates without ever being sold. These warning signs prompted a deeper look into the numbers.

This analytical review is the response. Using Excel-powered dashboards, KPIs, and pivot analytics, I investigated the inventory behavior, uncovering which products move fast, which warehouses are efficient, and which categories demand attention. By understanding what drives reorder alerts, how expiry risks cluster, and where turnover trends fluctuate, Sullivan’s Grocery aims to transform its inventory process from reactive to proactive.

This isn’t just about tracking boxes, it’s about telling the story of stock, using data to make smarter decisions, minimizing waste, and ensuring that the shelves reflect the needs of the people who walk through the doors every day.


🎯 OBJECTIVE OF THE PROJECT

To evaluate the grocery’s inventory performance, uncover inefficiencies, and design data-driven strategies for better stock management, reduced waste, and optimal sales alignment.

❗ PROBLEM STATEMENT

Sullivan’s Grocery manages a large volume of products across various warehouses. However, challenges such as overstocking, understocking, frequent reorder of discontinued items, and nearing expiry products threaten the overall efficiency and profitability.
...
Sullivan’s Grocery operates in a fast-paced retail environment where inventory precision is vital. However, the dataset reveals critical operational bottlenecks:
...
This multi-layered solution framework is designed not just to fix current inefficiencies but to establish a scalable model for future inventory excellence at Sullivan’s Grocery.
...
Sullivan’s internal inventory management system.
...
Inventory_Value Stock value = Quantity × Unit Price
...
✅ Insight: Stocking decisions should prioritize top-selling categories. Low-performing ones need marketing support or reassessment.

📈 Yearly Turnover Rate Trend (2020–2025)
...
✅ Insight: Fluctuating trends suggest inventory turnover success isn’t consistent — further optimization and seasonality planning are required.

📦 Stock Quantity by Reorder Level
...
✅ Insight: Overstock in Fruits & Vegetables might lead to wastage; more agile restocking strategies are needed.

⏰ Expiry Risk Days

206 items will expire in 1,095 days (3 years). Other risk categories include: 1,825, 730, 365, and 1460 days.

✅ Insight: Long shelf-life items dominate, but planning should still address items with closer expiration windows (e.g., 365 or 730 days).

💲 Sales by Inventory Value

The SKU group 40094–50093 has the highest sales value at $8.43M. 30094–40093, 50094–60093 groups follow with declining values at $6.5M, $5.4M, etc. The group 94–10093 has the lowest sales at $990K.

✅ Insight: Significant sales are concentrated in specific product groups. These should be prioritized for restocking and promotions.
...
✅ Insight: Top 3 warehouses are near capacity — redistribution or location-based demand forecasting could optimize this.

📉 Reorder Status

17,601 products are Discontinued, while 16,235 are in Backorder, and only 16,867 are Active.

✅ Insight: More products are discontinued than active — a serious inventory inefficiency. A reassessment of procurement strategies is necessary.

🏆 Top 8 Products by Reorder
...
✅ Insight: High reorder frequency of certain items can inform automatic restocking systems and vendor prioritization.

🎯 Bonus Insights from Sidebar KPIs

Top Product by Reorder: 🥇 Bread Flour
Top Warehouse by Distribution: 🏢 20 Pennsylvania Parkway
Most Reordered Products Are Discontinued: ❌
Fruits & Vegetables = Top Stocked Category: 🥦
206 Products Will Expire in 1,095 Days: ⌛

✅ Insight: KPI cards summarize critical problem zones (e.g., discontinued products still reordered), suggesting gaps in process automation.
...
Based on extensive data exploration and KPI analysis, the following multi-tiered recommendations are proposed to address current inefficiencies and drive inventory excellence at Sullivan’s Grocery:
...
By embedding these recommendations into daily and strategic operations, Sullivan’s Grocery can not only eliminate existing inefficiencies but also future proof its inventory system through agility, insight, and automation.
...
This structured analytical flow ensured a robust data journey from discovery to strategy, delivering clear, actionable insights to optimize Sullivan’s Grocery’s inventory performance and operational excellence.
...
Each visualization narrates the real-time efficiency and pressure points of Sullivan’s inventory system highlighting which categories need optimization and which SKUs are over- or under-performing.
...
As we close the chapter on this analysis of Sullivan’s Grocery’s inventory landscape, one thing becomes abundantly clear: behind every successful grocery shelf is not just a product, but a decision, a choice informed by data, trends, and timing.

From the moment goods enter the warehouse to the second they reach a customer’s basket, each step tells a story of efficiency, foresight, and sometimes, oversight. The analysis revealed powerful insights: how Fruits & Vegetables lead in volume, why Bread Flour tops the reorder list, and how certain warehouses consistently outperform others in stock management. We also uncovered vulnerabilities such as 206 products edging dangerously close to expiration, and the disproportionate volume of discontinued products still being reordered.

Through KPIs, pivot tables, and interactive charts, the fog of uncertainty gave way to patterns and clarity. What was once just data is now actionable intelligence. Inventory turnover is no longer a mystery, it’s a measurable pulse of the business. Expiry risks are no longer silent threats, they are now visible markers that spark timely intervention.

But this is not the end, it’s the beginning of a smarter supply chain strategy. With these insights in hand, Sullivan’s Grocery is equipped not just to react, but to anticipate. To not only stock better, but to sell smarter. To minimize waste, maximize profit, and most importantly to meet the evolving needs of every customer.

Because in the world of retail, the shelf is only as good as the system behind it. And now, Sullivan’s system has a story, one that’s driven by data, defined by insight, and shaped for smarter decisions ahead.
...
Sullivan’s Grocery Dataset (Internal) — Source of the raw data used in analysis. Includes variables like inventory level, reorder thresholds, product categories, and sales.
Inventory Management: Principles and Strategies for the Efficient Flow of Inventory — By John Toomey, used to guide reorder process improvements and SKU analysis.
Retail Analytics: The Secret Weapon — Deloitte Report 2020. Helped identify KPIs relevant to retail inventory tracking.
Excel Jet — Source for Excel formulas and pivot table techniques used throughout the analysis.
